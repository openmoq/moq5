...
- [Integration](integration.md) — Adapter loop, control/data byte feeding, action/event polling, cleanup obligations, backpressure retry, owned client credential sources
...
- [CAT4MoQ support design](cat4moq-design.md) — C4M-01 and current-relay compatibility, ownership and enforcement boundaries
